...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">    
  ...
  <div class="w3-row">
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round w3-white">
        <div class="w3-container">
		 ...
		 $usernamefromcookie = $_SESSION['username'];
		 
	  $db = new PDO("mysql:host=localhost;dbname=giftlist","root","2005eren07");

	$opinionsor = $db->prepare("SELECT * FROM users WHERE username = '$usernamefromcookie'");
	$opinioncek=$opinionsor->fetch(PDO::FETCH_ASSOC); ?>
         ...
         <p><i class="fa fa-birthday-cake fa-fw w3-margin-right w3-text-theme"></i> <?php echo $opinioncek['birthday'] ?></p><br>
